...
/******************************************************************************/
sbit TCS_SCL_PIN	= P1^7;
sbit TCS_SDA_PIN 	= P1^5;
...
#define TCS_SDA_READ   TCS_SDA_PIN
 
#define TCS_SCL_H     {TCS_SCL_PIN = 1;}
#define TCS_SCL_L     {TCS_SCL_PIN = 0;}
#define TCS_SDA_H     {TCS_SDA_PIN = 1;}
#define TCS_SDA_L     {TCS_SDA_PIN = 0;}
/******************************************************************************/
