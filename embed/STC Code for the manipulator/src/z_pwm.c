...
void car_pwm_set(int car_left, int car_right) {
	...
	static char car_zx_count = 0, car_zx_count0 = 0;
...
//	car_right = -car_right;
//	
//	if(car_left>-30 && car_left<30)car_left=0;
//	if(car_right>-30 && car_right<30)car_right=0;
//	
//	if(car_right>0) {
//		PWM3_SetPwmWide(car_right);
//		PWM2_SetPwmWide(0);
//	} else {
//		PWM3_SetPwmWide(0);
//		PWM2_SetPwmWide(-car_right);
//	}
//	
//	if(car_left>0) {
//		PWM4_SetPwmWide(car_left);
//		PWM5_SetPwmWide(0);		
//	} else {
//		PWM4_SetPwmWide(0);
//		PWM5_SetPwmWide(-car_left);
//	}	
