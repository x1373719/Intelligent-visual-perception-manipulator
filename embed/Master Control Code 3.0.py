...
serGHT.write('AT+TCDEVINFOSET=1,"EES7ENOZFA","weilaiRoad_Lamp001","AZGW8Krjwb9WfBXMwqX68A=="\r\n'.encode('utf-8'))
time.sleep(0.3)

serGHT.write('AT+TCMQTTCONN=1,20000,240,1,1\r\n'.encode('utf-8'))
time.sleep(0.3)

serGHT.write('AT+TCMQTTSUB="$thing/down/property/EES7ENOZFA/weilaiRoad_Lamp001",1\r\n'.encode('utf-8'))
time.sleep(0.3)

serGHT.write('AT+TCMQTTPUB="$thing/up/property/EES7ENOZFA/weilaiRoad_Lamp001",1,"{\\"method\\":\\"report\\",\\"clientToken\\":\\"123\\",\\"params\\":{\\"power_switch1\\":1}}"\r\n'.encode('utf-8'))
time.sleep(0.3)

print('AT+TCMQTTPUB="$thing/up/property/EES7ENOZFA/weilaiRoad_Lamp001",1,"{\\"method\\":\\"report\\",\\"clientToken\\":\\"123\\",\\"params\\":{\\"power_switch\\":0}}"\r\n')

serGHT.write('AT+TCMQTTDISCONN\r\n'.encode('utf-8'))
time.sleep(1.1)

serGHT.write('AT+MIPCALL=0\r\n'.encode('utf-8'))
time.sleep(1.1)
##############################################################################
servo = Servo(PWM0)
speck1 = LED(1)
...
ser.write('$KMS:0,280,235,1000!'.encode('utf-8'))
time.sleep(1.4)
...
#send message
#########################################################
serGHT.write('AT+CMGF=1\r\n'.encode('utf-8'))
time.sleep(1.1)
serGHT.write('AT+CSMP=17,167,0,0\r\n'.encode('utf-8'))

time.sleep(1.1)
serGHT.write('AT+CMGS="13296588098"\r\n'.encode('utf-8'))

time.sleep(1.1)
#ser.write('您好，吴同学。您在7月13日完成了核酸检测，记得三天后再次进行检测，谢谢您的配合。'.encode('utf-8'))
serGHT.write('Hello, classmate Wu. You completed the nucleic acid test on July 13. Remember to test again three days later. Thank you for your cooperation.'.encode('utf-8'))
...
serGHT.write('AT+TCMQTTPUB="$thing/up/property/EES7ENOZFA/weilaiRoad_Lamp001",1,"{\\"method\\":\\"report\\",\\"clientToken\\":\\"123\\",\\"params\\":{\\"power_switch1\\":0}}"\r\n'.encode('utf-8'))
time.sleep(0.3)
